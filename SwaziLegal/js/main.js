    ...
    if (practicesPreview) {
        ...
        practicesPreview.innerHTML = practices.map(practice => `
            <div class="practice-card">
                ${practice.image ? `<img src="${practice.image}" alt="${practice.name}" class="practice-image" loading="lazy">` : ''}
    ...
    if (teamPreview) {
        ...
        teamPreview.innerHTML = team.map(member => `
            <div class="team-card-new" onclick="viewTeamMember(${member.id})" style="padding: 2rem; display: flex; align-items: center; gap: 2rem; text-align: left;">
                ${member.image ?
                `<img src="${member.image}" alt="${member.name}" class="team-avatar-circle" style="width: 120px; height: 120px; margin: 0;" loading="lazy">` :
            ...
            <div class="testimonial-slide">
                <div class="testimonial-card">
                    <div class="testimonial-header">
                        ${testimonial.avatar ?
                `<img src="${testimonial.avatar}" alt="${testimonial.client}" class="testimonial-avatar" loading="lazy">` :
            ...
            <div style="margin-bottom: 3rem;">
                <div class="grid grid-2" style="align-items: center; gap: 2rem;">
                    ...
                    <div ${index % 2 === 1 ? 'style="order: 1;"' : ''} class="glass-card" style="padding: 2rem;">
                        ${practice.image ? `<img src="${practice.image}" alt="${practice.name}" class="about-image" style="margin-bottom: 1.5rem;" loading="lazy">` : ''}
    ...
    teamFullList.innerHTML = team.map(member => {
        ...
        <div class="masonry-item animate-on-scroll">
            <div class="team-card-new" onclick="viewTeamMember(${member.id})">
                ${member.image
                ? `<img src="${member.image}" alt="${member.name}" class="team-avatar-circle" loading="lazy">`
...
function viewTeamMember(memberId) {
    ...
    modalContent.innerHTML = `
        <div style="text-align: center; margin-bottom: 1.5rem;">
            ${member.image ?
            `<img src="${member.image}" alt="${member.name}" class="team-image" style="width: 200px; height: 200px; border-radius: 50%; object-fit: cover; margin-bottom: 1.5rem; border: 4px solid var(--primary-blue);">` :
